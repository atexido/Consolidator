...
cliente = 'MEJOR CREDITO RECOVERY'
cliente_temp = 'MejorCredito'
...
if os.path.isfile(F'M:/PAGOS/__Pagos/Pagos_Test/Pagos_Test/bin/Temp/{cliente_temp}/Sucursal/VALIDOS.xlsx'):
    ...
    if os.path.isfile(f'H:/Casos/2023/{mes_actual_espanol_carpeta}/{cliente}/PAGOS/{cliente} PAGOS ACUMULADOS.xlsx'):
        ...
        df_casos = pd.read_excel(f'H:/Casos/2023/{mes_actual_espanol_carpeta}/{cliente}/PAGOS/{cliente} PAGOS ACUMULADOS.xlsx')
